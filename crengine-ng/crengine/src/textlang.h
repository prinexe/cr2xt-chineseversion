...
public:
    ...
    static void setMainLang(lString32 lang_tag) {
        _main_lang = lang_tag;
    }
    ...
    static bool getEmbeddedLangsEnabled() {
        return _embedded_langs_enabled;
    }

    static bool getHyphenationEnabled() {
        return _hyphenation_enabled;
    }
    ...
    static bool getHyphenationForceAlgorithmic() {
        return _hyphenation_force_algorithmic;
    }
...
public:
...
#if USE_LIBUNIBREAK == 1
    bool hasLBCharSubFunc() const {
        return _lb_char_sub_func != NULL;
    }
    ...
    bool duplicateRealHyphenOnNextLine() const {
        return _duplicate_real_hyphen_on_next_line;
    }
