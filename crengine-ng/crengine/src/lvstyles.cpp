...
lUInt32 calcHash(css_style_rec_t& rec) {
    if (!rec.hash)
        rec.hash = (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((
         ...
         + (lUInt32)rec.cr_footnote_marker_before.getHash()
         + (lUInt32)rec.cr_footnote_marker_after.getHash());
    return rec.hash;
}

bool operator==(const css_style_rec_t& r1, const css_style_rec_t& r2) {
    return r1.important[0] == r2.important[0] &&
           ...
           r1.cr_footnote_marker_before == r2.cr_footnote_marker_before &&
           r1.cr_footnote_marker_after == r2.cr_footnote_marker_after;
}
...
#define ST_GET_LEN(v)                 \
    {                                 \
        ...
        lInt32 val;                   \
        buf >> val;                   \
        v.type = (css_value_type_t)t; \
        v.value = val;                \
        if (buf.error())              \
            return false;             \
    }
#define ST_PUT_LEN4(v) \
    ST_PUT_LEN(v[0]);  \
    ST_PUT_LEN(v[1]);  \
    ST_PUT_LEN(v[2]);  \
    ST_PUT_LEN(v[3]);
#define ST_GET_LEN4(v) \
    ST_GET_LEN(v[0]);  \
    ST_GET_LEN(v[1]);  \
    ST_GET_LEN(v[2]);  \
    ST_GET_LEN(v[3]);
#define ST_PUT_UI64(v) buf << (lUInt32)(v >> 32) << (lUInt32)(v & 0xFFFFFFFFULL)
#define ST_GET_UI64(v)          \
    {                           \
        lUInt32 t;              \
        buf >> t;               \
        v = (lUInt64)(t) << 32; \
...
bool css_style_rec_t::serialize(SerialBuf& buf) {
    ...
    buf << cr_footnote_marker_before;
    buf << cr_footnote_marker_after;
